    ...
    <div className="flex flex-col items-center">
      <div className="container">
        <div className="flex flex-col sm:flex-row justify-center items-center py-20">
          <p className="sm:mr-7 text-black alt-font font-medium pb-4 leading-6 sm:pb-0 xl:text-[20px] xl:leading-[26px]">
            We’d love to hear about your project
          </p>
          <Button className="alt-font font-semibold" variant="red">
            Get in touch
          </Button>
        </div>
        <div className="grid grid-cols-12 pt-8">
          ...
          <div className="col-span-12 md:col-span-5 lg:col-span-3 md:px-[13px]">
            <div className="pre-footer-header mt-[2px]">
              Contact Information
            </div>
            <div className="text-medium-gray md:text-[16px]">
              ...
              <p className="md:leading-5">
                Email:
                <a
                  className="font-size13 text-medium-gray"
                  href="mailto:Hello@MakeYourMarkDigital.com"
                >
                  {" "}
                  Hello@MakeYourMarkDigital.com
                </a>
              </p>
          ...
          <div className="col-span-12 md:col-span-3 lg:col-span-2 md:px-[13px]">
            ...
            <div className="text-medium-gray md:text-[16px]">
              <a
                href="https://www.instagram.com/makeyourmarkdigital/"
                target="_blank"
              >
                <p className="pb-1 md:p-0">Instagram</p>
              </a>
              <a
                href="https://www.linkedin.com/company/make-your-mark-digital/"
                target="_blank"
              >
                <p className="pb-1 md:p-0">Linkedin</p>
              </a>
              <a
                href="https://www.facebook.com/MakeYourMarkDigital/"
                target="_blank"
              >
            ...
            <img
              className="w-[120px] py-[30px] mt-[30px] border-t border-black"
              src="/img/WOSB-logo.webp"
            />
            <a href="https://www.semrush.com/agencies/" target="_blank">
              <img
                className="w-[120px] py-[30px] border-t border-black"
                src="/img/awards-logo.webp"
              />
            </a>
            <a
              href="https://www.expertise.com/business/digital-marketing-agencies/pennsylvania/philadelphia"
              target="_blank"
            >
              <img
                className="w-[120px] py-[30px] border-t border-black"
            ...
            <a
              href="https://portal.us.bn.cloud.ariba.com/profile/public?anId=AN11205055557&sourceApplication=SBN&btpDeploymentEnabled=true"
              target="_blank"
            >
              <img
                className="w-[120px] py-[30px] border-t border-black"
          ...
          <div className="col-span-12 md:col-span-4 lg:col-span-5 md:px-[13px]">
            ...
            <form className="text-medium-gray font-" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  className={`border-b text-sm w-full indent-[2%] ${
              ...
              <div className="py-6">
                <Button
                  className="alt-font font-semibold"
                  variant="red"
                  type="submit"
                >
                  Subscribe
